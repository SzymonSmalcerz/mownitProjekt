...
public class MonitorCPUTemperatureEventSubscriber extends MonitorEventSubscriber {

  

    public MonitorCPUTemperatureEventSubscriber(MongoCollection<Document> collection) {
		super(collection);
	}
