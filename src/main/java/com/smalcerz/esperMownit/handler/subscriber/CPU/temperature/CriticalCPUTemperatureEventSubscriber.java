...
public class CriticalCPUTemperatureEventSubscriber extends CriticalEventSubscriber {


    public CriticalCPUTemperatureEventSubscriber(MongoCollection<Document> collection) {
		super(collection);
	}
